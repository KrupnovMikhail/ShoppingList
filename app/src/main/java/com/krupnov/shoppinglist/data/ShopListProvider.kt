package com.krupnov.shoppinglist.data
...
import com.krupnov.shoppinglist.presentation.ShopApplication
...
class ShopListProvider : ContentProvider() {
    ...
    private val uriMatcher = UriMatcher(UriMatcher.NO_MATCH).apply {
        addURI("com.krupnov.shoppinglist", "shop_items", GET_SHOP_ITEMS_QUERY)
        addURI("com.krupnov.shoppinglist", "shop_items/#", GET_SHOP_ITEMS_BY_ID_QUERY)
    }
